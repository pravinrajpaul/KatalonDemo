...
//@AfterTestCase
//def onTestFailure(TestCaseContext testCaseContext) {
//	if (testCaseContext.getTestCaseStatus() == "FAILED") KeywordUtil.markFailed(CustomKeywords.'custom.Report.takeScreenShot'())
//}
